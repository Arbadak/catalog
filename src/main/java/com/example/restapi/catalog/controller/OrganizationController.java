...
public class OrganizationController {
    ...
    /// При неверноем типе будет выдаватьcя ошибка
    @ExceptionHandler (com.fasterxml.jackson.databind.exc.InvalidFormatException.class)
   public @ResponseBody ResponceWrapper handleException(com.fasterxml.jackson.databind.exc.InvalidFormatException e)
   {return  new ResponceWrapper(new resultResponce(null,"неверный тип данных"));}
    ...
    public ResponceWrapper org(@PathVariable("id") Integer id){return new ResponceWrapper(organizationService.getOne(id)); }
    ...
    public ResponceWrapper save(@RequestBody RawOrganization rawOrganization) {
        ...
        if( rawOrganization.getInn()==null ||
                ...
                rawOrganization.getIsActive() == null){return new ResponceWrapper(new resultResponce(null, "не указан обязательный параметр"));}
